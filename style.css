...
#current-date { font-size: 11px; color: #555; }
#current-time { font-size: 16px; font-weight: 600; color: #222; }
...
#btn-now:hover { background: rgba(255,255,255,0.35); }
#btn-cancel-cal {
    background: none; border: none;
...
.cal-label {
    ...
    color: #1565c0; margin: 12px 0 8px 0;
}
...
.date-btn:hover { border-color: #1e88e5; }
.date-btn.selected {
